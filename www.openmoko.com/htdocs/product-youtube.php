...
<body>
        ...
        <div id="container">
            ...
            <div class="product-footer">
                ...
                <ul class="sub-nav">
                    ...
                    <li><a href="product-flickr.php">Flickr</a></li>
                    <li class="selected"><a href="product-youtube.php">YouTube</a></li>
            ...
            <h2 class="title">Community Videos Tagged: <i>"Openmoko + FreeRunner"</i></h2>
            
           	  <div class="gallery">
                 <?php disp_youtubethumbs(); ?>
              </div>
    ...
    <div class="legal"><p>Copyright &#169; 2009 Openmoko Inc. | <a href="terms-use.html" target="_blank">Terms of Use</a> | <a href="privacy-policy.html" target="_blank">Privacy Policy</a> | </p></div><!-- end .legal -->
