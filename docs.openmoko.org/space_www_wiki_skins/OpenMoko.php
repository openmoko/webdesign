...
<?php if($this->data['body_onload'    ]) { ?>onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="<?php $this->text('nsclass') ?> <?php $this->text('dir') ?>">
	...
	<div id="common_header">
		<a href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>" id="site_logo"><img src="<?php $this->text('logopath') ?>" alt="docs.openmoko.org" /></a>
		...
		<div id="main_navigation">
			<ul>
				...
				<li><a href="http://docs.openmoko.org/" class="nav_docs selected"><span>Docs</span></a></li>
